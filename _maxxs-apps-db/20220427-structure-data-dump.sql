...
CREATE TABLE `app_settings` (
  ...
  KEY `app_settings_created_by_foreign` (`created_by`) USING BTREE,
  KEY `app_settings_updated_by_foreign` (`updated_by`) USING BTREE
...
CREATE TABLE `permissions` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `permissions_created_by_foreign` (`created_by`) USING BTREE,
  KEY `permissions_updated_by_foreign` (`updated_by`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `role` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `role_created_by_foreign` (`created_by`) USING BTREE,
  KEY `role_updated_by_foreign` (`updated_by`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `role_permissions` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `role_permissions_created_by_foreign` (`created_by`) USING BTREE,
  KEY `role_permissions_updated_by_foreign` (`updated_by`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `url` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `url_created_by_foreign` (`created_by`) USING BTREE,
  KEY `url_updated_by_foreign` (`updated_by`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `url_access` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `url_access_created_by_foreign` (`created_by`) USING BTREE,
  KEY `url_access_updated_by_foreign` (`updated_by`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-04-27  9:05:15
